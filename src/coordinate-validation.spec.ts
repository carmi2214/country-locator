...
describe('validateCoordinate tests', () => {
    describe.each([
        ...
        test('should throw if latitude or longitude are not numbers, sending as coordinate', () => {
            expect(() => validateCoordinate({latitude, longitude}))
                .toThrow(`Invalid arguments were given. Must send either a coordinate or lat & long as numbers.`);
        });
